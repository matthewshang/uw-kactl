...
\section{Matching}
	Edge cover: Max matching then add edges

	Hall: $\exists$ matching cover left iff each subset of left nodes $S$ has neighborhood at least $|S|$
...
\section{Trees}
	...
	\kactlimport{CentroidDecompEvirir.h}
	\subsection{Prufer code}
	Remove smallest leaf, add leaf's neighbor to Prufer $(n - 2)$ times
